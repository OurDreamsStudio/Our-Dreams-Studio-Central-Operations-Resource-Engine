      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 flex flex-col items-center">
        ...
        <section id="contact" className="w-full max-w-2xl mb-16">
          <div className={`rounded-[2rem] p-8 sm:p-12 ${glassClasses} relative overflow-hidden`}>
            ...
            <form className="relative z-10 flex flex-col gap-5" autoComplete="off">
              ...
              <button
                type="button"
                className="w-full mt-4 py-4 rounded-xl bg-[#460362] text-white font-bold text-lg hover:bg-purple-900 transition-all shadow-xl shadow-[#460362]/20 hover:-translate-y-0.5 active:translate-y-0"
              >
                Solicitar Proposta
              </button>
            </form>
