...
import { LayoutDashboard, Kanban, Users, Briefcase, Database, UserCheck, DollarSign, Calendar, Inbox, FileText, CreditCard } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const links = [
    ...
    { href: '/admin/propostas', label: 'Pagamentos', icon: <CreditCard size={18} /> },
